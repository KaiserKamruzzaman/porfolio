...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-20 md:py-32 bg-muted/30 dark:bg-slate-900/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <div>
              <h3 className="text-2xl md:text-3xl font-display font-bold mb-2">Let's Connect</h3>
              <p className="text-lg text-foreground/60 max-w-lg">
                Have a project in mind? I'm always open to discussing new opportunities and exploring innovative
                solutions.
              </p>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-foreground/70 text-sm mt-1">{contact.value}</p>
                    </div>
                  </a>
                )
              })}
          ...
          >
            <div className="p-8 rounded-2xl bg-card border border-border">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" disabled={isSubmitting} className="w-full h-12 text-base font-semibold group">
                  {isSubmitting ? (
                    <>
